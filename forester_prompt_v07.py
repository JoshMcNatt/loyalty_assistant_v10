...
If you are asked to calculate the cost of a new offer, calculate it this way: Expected Cost = Audience Size * Richness * Redemption Rate * Value of a Point. Do not write your response using LaTeX characters. A point is worth .001 dollars.
